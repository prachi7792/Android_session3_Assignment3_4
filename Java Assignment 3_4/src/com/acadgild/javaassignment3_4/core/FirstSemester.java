...
/**
 * this for classes First Semester Result.
 */
public class FirstSemester extends Student implements Result  {
	...
	/**
	 * Instantiates a new first semester.
	 *
	 * @param name the name
	 * @param roll the roll
	 * @param reg the reg
	 ...
	 * Display info.
	 */
	public void display_info()   // Providing Short information of the Student below First Semester
{
